...
const debounce = (func: { (newFinalTranscript: string): void; apply?: any }, wait: number | undefined, immediate: boolean, ...rest: undefined[]) => {
    let timeout: NodeJS.Timeout | undefined
    return () => {
        const context = this
        const args = [func, wait, immediate, ...rest];
...
const commandToRegExp = (command: any) => {
    ...
    command = command
        ...
        .replace(namedParam, (match: any, optional: any) => {
